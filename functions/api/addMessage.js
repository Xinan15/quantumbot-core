...
exports.addMessage = functions.https.onCall(async (data, context) => {
  try {
    ...
    logger.log(
      "Message added successfully to Firestore, message ID: ",
      messageRef.id
    );
    ...
    // throw a structured error response for the client
    throw new functions.https.HttpsError(
      "unknown",
      "An error occurred while adding the message to Firestore",
      error.message
    );
  }
});
